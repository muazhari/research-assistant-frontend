...
import CreateOneRequest from "../models/value_objects/contracts/requests/managements/web_documents/CreateOneRequest.ts";
...
import PatchOneByIdRequest from "../models/value_objects/contracts/requests/managements/web_documents/PatchOneById.ts";
...
export default class WebDocumentService extends Service {
    ...
    createOne(request: CreateOneRequest): Promise<AxiosResponse<Content<WebDocument>>> {
        return this.client.instance.post(`${this.path}`, request.body);
    }

    deleteOneById(request: DeleteOneByIdRequest): Promise<AxiosResponse<Content<WebDocument>>> {
        return this.client.instance.delete(`${this.path}/${request.id}`);
    }

    readAll(): Promise<AxiosResponse<Content<WebDocument[]>>> {
        return this.client.instance.get(`${this.path}`);
    }

    readAllByAccountId(request: ReadAllByAccountIdRequest): Promise<AxiosResponse<Content<WebDocument[]>>> {
        return this.client.instance.get(`${this.path}?account_id=${request.accountId}`);
    }

    readOneById(request: ReadOneByIdRequest): Promise<AxiosResponse<Content<WebDocument>>> {
        return this.client.instance.get(`${this.path}/${request.id}`);
    }

    patchOneById(request: PatchOneByIdRequest): Promise<AxiosResponse<Content<WebDocument>>> {
